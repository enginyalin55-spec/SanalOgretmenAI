...
// --- FINAL PDF (OCR + Öğretmen Değerlendirmesi DAHİL) ---
const downloadPDF = async () => {
  ...
  style.innerHTML = `
    ...
    /* OCR METNİ (ÖĞRENCİ YAZISI) */
    .pdf-mode .ocr-text,
    .pdf-mode .student-text {
      display: block !important;
