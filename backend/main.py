...
app = FastAPI(title="Sanal Ogretmen AI API", version="3.3.0 (Full Logic + New Rubric)")
...
# =======================================================
# 4) TEXT & TDK UTILS (ESKİ KODLARIN HEPSİ BURADA)
# =======================================================

# --- GÜNCELLENMİŞ STANDART TDK LİSTESİ ---
...
async def ocr_image(file: UploadFile = File(...), classroom_code: str = Form(...)):
    try:
        ...
        try:
            ...
            return {"status": "error", "message": "Vision API Hatası"}
        ...
        return {
            ...
            "image_url": image_url,
            "ocr_notice": "Düşük güvenli karakterler ⍰ ile işaretlendi.",
...
# =======================================================
# ANALYZE: YENİLENMİŞ 2 AŞAMALI (TDK STD + 6 KRİTER)
# =======================================================
@app.post("/analyze")
async def analyze_submission(data: AnalyzeRequest):
    ...
    # 2. AŞAMA: CEFR PUANLAMA (Seviyeye Özel Beklentiler)
    level_expectations = ""
    if data.level == "A1":
        level_expectations = """
