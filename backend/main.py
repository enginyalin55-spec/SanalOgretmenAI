...
# =======================================================
# 🛡️ TDK KURALLARI (KOD İÇİNE GÖMÜLÜ - DOSYA ARANMAZ!)
# =======================================================
...
def validate_analysis(result: Dict[str, Any], full_text: str, allowed_rule_ids: set) -> Dict[str, Any]:
    ...
    for err in raw_errors:
        ...
        if not isinstance(span, dict) or "start" not in span or "end" not in span:
            # Span yoksa fallback yapmıyoruz, hata reddedilir
            continue
        ...
        # Case-sensitive check yapmak isterseniz .lower() kaldırın. 
        # Burada modelin tam olarak doğru kelimeyi işaret ettiğinden emin oluyoruz.
    ...
    # Çakışma temizliği: aynı bölgede çakışma varsa daha uzun olanı tut
